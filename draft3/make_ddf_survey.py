...
def ddf_slopes(ddf_name, raw_obs, night_season, ss=29):
    """
    ...
    if ddf_name == 'COSMOS':
        ...
        season_vals = {0: 10, 1: 185, 2: 185, 3: 10, 4: 10, 5: 10,
                       6: 10, 7: 10, 8: ss, 9: ss, 10: 10}
...
def optimize_ddf_times(ddf_name, ddf_RA, ddf_grid,
                       ...
                       g_depth_limit=23.5, sequence_limit=258, season_frac=0.1, ss=29):
    """
    ...
    cumulative_desired = ddf_slopes(ddf_name, raw_obs, night_season, ss=ss)
...
def generate_ddf_scheduled_obs(data_file='ddf_grid.npz', flush_length=2, mjd_tol=15, expt=30.,
                               ...
                               nsnaps=[1, 2, 2, 2, 2, 2], sequence_limit=258, ss=29):
    ...
    for ddf_name in ['ELAISS1', 'XMM_LSS', 'ECDFS', 'COSMOS', 'EDFS_a']:
        ...
        mjds = optimize_ddf_times(ddf_name, ddfs[ddf_name][0], ddf_grid,
                                  ...
                                  sequence_limit=sequence_limit, ss=ss)[0]
        for mjd in mjds:
