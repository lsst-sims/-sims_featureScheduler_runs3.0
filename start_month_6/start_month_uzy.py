...
from rubin_sim.utils import _hpid2RaDec, angularSeparation, survey_start_mjd
import rubin_sim
...
def ddf_surveys(detailers=None, season_frac=0.2, euclid_detailers=None, mjd_start=None):
    obs_array = generate_ddf_scheduled_obs(season_frac=season_frac, mjd_start=mjd_start)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--month_offset", type=float, default=0)
    ...
    mjd_start = survey_start_mjd() + 30.*month_offset
    ...
    if dbroot is None:
        ...
        fileroot = dbroot + '_'
    file_end = '%i_' % month_offset + 'v2.99_'
